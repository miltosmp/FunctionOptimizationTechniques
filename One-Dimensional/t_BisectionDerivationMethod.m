...
for i = 1:10
    ...
    [a1, ~] = BisectionDerivationMethod(f1, l, a, b);
    num1(i) = size(a1, 2);
    
    tic
    [a2, ~] = BisectionDerivationMethod(f2, l, a, b);
    num2(i) = size(a2, 2);
    
    tic
    [a3, ~] = BisectionDerivationMethod(f3, l, a, b);
    num3(i) = size(a3, 2);
end
...
for i = 1:6
    [a_f1, b_f1] = BisectionDerivationMethod(f1, l(i), a, b);
    a1(i, 1:length(a_f1)) = a_f1;
    b1(i, 1:length(b_f1)) = b_f1;
    [a_f2, b_f2] = BisectionDerivationMethod(f2, l(i), a, b);
    a2(i, 1:length(a_f2)) = a_f2;
    b2(i, 1:length(b_f2)) = b_f2;
    [a_f3, b_f3] = BisectionDerivationMethod(f3, l(i), a, b);
