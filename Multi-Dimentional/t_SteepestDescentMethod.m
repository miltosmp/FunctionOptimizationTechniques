...
x0 = 0;
y0 = 0;
[x_s0, y_s0] = SteepestDescentMethod(f, x, y, x0, y0, 0.01, 0);
[x_s1, y_s1] = SteepestDescentMethod(f, x, y, x0, y0, 0.01, 1);
[x_s2, y_s2] = SteepestDescentMethod(f, x, y, x0, y0, 0.01, 2);
